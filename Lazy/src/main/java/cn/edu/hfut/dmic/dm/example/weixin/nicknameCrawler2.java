 ...
 *
 */
public class nicknameCrawler2 extends BreadthCrawler {
	 ...
	 */
	public nicknameCrawler2(String crawlPath, boolean autoParse, int id, String year) {
		super(crawlPath, autoParse);
		String url = "http://www.qqtn.com/wm/weixinwm_" + id + ".html";
		this.addSeed(url);//
	...
	public void visit(Page page, CrawlDatums next) {
		if (page.matchUrl("http://www.qqtn.com/wm/weixinwm_.*html")) {
	...
	public static void execute(int pagesize) throws Exception {
		int i = pagesize;
		while (i > 0) {
			nicknameCrawler2 crawler = new nicknameCrawler2("crawl", true, i, "2016");
	...
	public static void method3( String content) {
		String file="D:/test/nickname.txt";
