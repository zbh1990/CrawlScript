 ...
 *
 */
public class pinglunCrawler extends BreadthCrawler {
	 ...
	 */
	public pinglunCrawler(String crawlPath, boolean autoParse, int id, String year) {
	...
	public static void execute(int pagesize) throws Exception {
		int i = pagesize;
		while (i > 0) {
			pinglunCrawler crawler = new pinglunCrawler("crawl", true, i, "2016");
