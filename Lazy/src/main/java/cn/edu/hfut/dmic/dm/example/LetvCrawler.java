...
public class LetvCrawler extends BreadthCrawler {
	...
	public LetvCrawler(String crawlPath, boolean autoParse,int id) {
		...
		/* start page */
		this.addSeed("http://list.le.com/listn/c1_t-1_a-1_y-1_s1_lg-1_ph-1_md_o9_d1_p1.html");//电视剧
	...
	public void visit(Page page, CrawlDatums next) {
		...
		if (page.matchUrl("http://www.le.com/movie/.*html")) {
			...
			String s_url = page.select(".showPic").get(0).childNodes().get(1).attr("href");//s_url.substring(0, s_url.length() - 1);
